...
export const DIY_CLOWNS_ACTIONS: ActionCardDef[] = [
    ...
    { id: 'diy_clowns_clown_pyramid', type: 'action', subtype: 'standard', name: '小丑金字塔', nameEn: 'Clown Pyramid', faction: FACTION, abilityTags: ['onPlay'], playNeedsBase: true, count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 13 } },
