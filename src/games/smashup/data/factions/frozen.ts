...
export const FROZEN_MINIONS: MinionCardDef[] = [
    ...
    { id: 'frozen_olaf', type: 'minion', name: '雪宝', nameEn: 'Olaf', faction: FACTION, power: 3, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 17 } },
    { id: 'frozen_sven', type: 'minion', name: '斯文', nameEn: 'Sven', faction: FACTION, power: 3, abilityTags: ['talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 18 } },
    { id: 'frozen_anna', type: 'minion', name: '安娜', nameEn: 'Anna', faction: FACTION, power: 4, abilityTags: ['onPlay', 'ongoing'], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 19 } },
    { id: 'frozen_kristoff', type: 'minion', name: '克里斯托弗', nameEn: 'Kristoff', faction: FACTION, power: 4, abilityTags: ['ongoing', 'talent'], activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 20 } },
...
export const FROZEN_ACTIONS: ActionCardDef[] = [
    ...
    { id: 'frozen_frozen_port', type: 'action', subtype: 'ongoing', name: '冻结的港口', nameEn: 'Frozen Port', faction: FACTION, abilityTags: ['ongoing', 'talent'], ongoingTarget: 'base', playNeedsBase: true, activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 25 } },
    { id: 'frozen_hans_westergaard', type: 'action', subtype: 'standard', name: '汉斯·韦斯特加德', nameEn: 'Hans Westergaard', faction: FACTION, abilityTags: ['onPlay'], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 26 } },
    { id: 'frozen_let_it_go', type: 'action', subtype: 'standard', name: '放手吧', nameEn: 'Let It Go', faction: FACTION, abilityTags: ['onPlay'], count: 2, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 27 } },
    { id: 'frozen_lock_the_gates', type: 'action', subtype: 'ongoing', name: '锁上大门', nameEn: 'Lock the Gates', faction: FACTION, abilityTags: ['ongoing', 'talent'], ongoingTarget: 'base', playNeedsBase: true, activatableAbilities: [{ kind: 'talent', zone: 'board', window: 'playCards' }], count: 1, previewRef: { type: 'atlas', atlasId: CARD_ATLAS, index: 28 } },
